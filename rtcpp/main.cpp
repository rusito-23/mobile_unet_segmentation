#include <iostream>
#include <zip.h>
#include "source/cxxopts/cxxopts.h"
#include "source/predict/predict.h"
...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    options.add_options()
      ("model-file", ".onnx or .zip file of the model.", cxxopts::value<string>())
    ...
    // initialize utils
    predictor = new ONNXPredictor(model_file, thres);
